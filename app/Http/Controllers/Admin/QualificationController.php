...
class QualificationController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.qualification.index', ['instructors' => $instructors->get(), 'courses' => $courses->get()]);
    }
    ...
    {
        // QualificationController::create($request->all());
        $qualification->insert($request->all());
    }
