...
<head>
    ...
    <title>E-Course | {{ $title ?? 'Dashboard' }}</title>
...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; E-Course {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script>
        $(document).ready(function() {
            var highestBox = 0;
            $('.titleEqualHeight', this).each(function() {
                if ($(this).height() > highestBox) {
                    highestBox = $(this).height();
                }
            });
            $('.titleEqualHeight', this).height(highestBox);
        });
    </script>
    @stack('js')
</body>
