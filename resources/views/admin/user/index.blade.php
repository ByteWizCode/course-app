  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="createForm">
        <input type="hidden" required="" name="role" value="user" class="form-control">
        ...
        <div class="form-group">
            <label for="r">Member</label>
            <select name="member" id="r" class="form-control">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="hidden" required="" id="role" name="role" value="user" class="form-control">
            <input readonly="readonly" type="" required="" id="name" name="name" class="form-control">
        </div>
        <div class="form-group">
