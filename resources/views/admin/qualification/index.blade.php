@extends('layout.backend.app',[
    ...
    'pageTitle' =>'Manage Qualification',
])
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <select required name="TopicID" id="rszs" class="form-control">
        ...
        <div class="form-group">
            ...
            <select required name="InstructorID" id="rss" class="form-control">
                <option disabled="">- Choose One -</option>
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'TopicID', name: 'TopicID'},
            {data: 'InstructorID', name: 'InstructorID'},
