...
<script type="text/javascript">
  $(function() {
    ...
    var table = $('.data-table').DataTable({
      processing: true,
      serverSide: true,
      ajax: "{{ route('reportresult.index') }}?Member={{ $Member }}&CourseID={{ $CourseID }}&InstructorID={{ $InstructorID }}",
      columns: [{
          data: 'DT_RowIndex',
          name: 'ID'
        },
  ...
  $('body').on("click", ".btn-edit", function() {
    var id = $(this).attr("id")
    $.ajax({
      url: "/admin/reportresult/" + id + "/edit",
      method: "GET",
