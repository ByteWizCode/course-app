...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="/">E-Course</a>
...
<div class="container-fluid mt-5">
	...
	<div class="jumbotron">
    @guest
    <h1 class="display-4">Selamat Datang di E-Course</h1>
    @endguest
    ...
    <p class="lead">Silahkan Login / Register untuk Pesan Course Terbaik dari Kami.</p>
	  <hr class="my-4">
  </div>
