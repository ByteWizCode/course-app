			...
			<div class="card-body">
				...
				@method('PATCH')
					<div class="form-group">
						...
						<input required="" value="{{ Auth::user()->email }}" class="form-control" type="" id="email" name="email">
					</div>
					<div class="form-group">
						<label for="gender">Gender</label>
						<select name="gender" id="gender" class="form-control">
							<option disabled="">- PILIH GENDER -</option>
							<option @if (Auth::user()->gender == 'Pria') selected="selected" @endif value="Pria">Pria</option>
							<option @if (Auth::user()->gender == 'Wanita') selected="selected" @endif value="Wanita">Wanita</option>
						</select>
					</div>
					<div class="form-group">
