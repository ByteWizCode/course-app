...
use App\Http\Controllers\User\ReportResultController;
...
Route::group(['namespace' => 'Admin', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
	...
	Route::resource('/course', 'CourseController')->middleware(['can:admin']);
	Route::resource('/instructor', 'InstructorController')->middleware(['can:admin']);
	Route::resource('/qualification', 'QualificationController')->middleware(['can:admin']);
	Route::resource('/report', 'ReportController')->middleware(['can:admin']);
	Route::resource('/reportresult', 'ReportResultController')->middleware(['can:admin']);
...
Route::group(['namespace' => 'User', 'middleware' => 'auth', 'prefix' => 'user'], function () {
	...
	Route::get('/enrolled', [UserController::class, 'enrolled'])->name('user.enrolled');
	Route::post('/user/submitcourse', [UserController::class, 'submitcourse'])->name('user.submitcourse');
	Route::get('/profile', [ProfileController::class, 'index'])->name('profile');
	Route::patch('/profile/update/{user}', [ProfileController::class, 'update'])->name('profile.update');
	Route::resource('/transaction', 'ReportResultController')->middleware(['can:user']);
});
